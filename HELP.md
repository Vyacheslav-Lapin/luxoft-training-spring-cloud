...
* The original package name 'ru.vlapin.trainings.luxoft-training-spring-cloud' is invalid and this project uses 'ru.vlapin.trainings.luxofttrainingspringcloud' instead.
